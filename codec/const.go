...
const (
	...
	l_LIRC_GET_FEATURES         = uint(0x80046900)
	l_LIRC_CAN_REC_MODE2        = uint32(0x40000)
	l_LIRC_CAN_SEND_PULSE       = uint32(0x2)
	l_LIRC_CAN_SET_SEND_CARRIER = uint32(0x100)

	l_LIRC_SET_REC_TIMEOUT_REPORTS = uint(0x40046919)

	l_LIRC_GET_SEND_MODE = uint(0x80046901)
	l_LIRC_SET_SEND_MODE = uint(0x40046911)
	l_LIRC_MODE_PULSE    = 2
