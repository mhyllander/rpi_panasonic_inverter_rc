...
func TestAdjustingPowerSetting1(t *testing.T) {
	...
	dbRc.Power = common.C_Power_On
	dbRc.TimerOn = common.C_Timer_Enabled
	dbRc.TimerOnTime = codec.NewTime(6, 0)
	dbRc.TimerOff = common.C_Timer_Enabled
	...
	if rc.Power != common.C_Power_Off {
